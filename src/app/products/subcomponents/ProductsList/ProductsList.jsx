...
const ProductsList = ({ changePage, data, showProductModal }) => {
    ...
    return (
        <main className='main-products container-xl'>
            <div className='row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 pt-5' data-testid='productsList'>
                {productsListEl}
            </div>
